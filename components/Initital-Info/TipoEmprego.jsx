    ...
    <div>
      <InfoForm setStep={setStep} step={step}>
        <div className='info-form-input'>
          ...
          <input type="text" name="area" id="area" placeholder='Sua área de atuação' maxLength={40} minLength={3} autoComplete='off' value={area} onChange={(e) => setArea(e.target.value)} required />
        </div>

        <div className='info-form-input'>
          <h3>Preferência de Emprego <span className='pink-span'>*</span></h3>
          <select name="preferencia_emprego" id="preferencia_emprego" onChange={(e) => setPreferenciaEmprego(e.target.value)} value={preferenciaEmprego} required>
